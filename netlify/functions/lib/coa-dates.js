 ...
 *
 * Everything else is null, including forms that look close: a two-digit year
 * (Kaycha prints its harvest dates as "07/07/25"), a one-digit month or day
 * ("7/7/2025"), a full month name, a dotted or day-first date, a date with a
 * time after it. Each would be one more line here; the reason to add one is
 * a prompt asking for it, not a guess at what labs print.
 *
