...
test/archive-scripts-test.js                          version, pdf-store, health, seed; offline, 20 checks
...
prompt's work. When it merges: run the seed once if it has not been run, then
do the checks above.
